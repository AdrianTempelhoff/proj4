...
class GroupPermissionsControllerTest < ActionController::TestCase
  ...
  test "should create group_permission" do
    assert_difference('GroupPermission.count') do
      post :create, group_permission: { permission_id: @group_permission.permission_id, user_group_id: @group_permission.user_group_id }
    end
  ...
  test "should update group_permission" do
    put :update, id: @group_permission, group_permission: { permission_id: @group_permission.permission_id, user_group_id: @group_permission.user_group_id }
    assert_redirected_to group_permission_path(assigns(:group_permission))
  end
